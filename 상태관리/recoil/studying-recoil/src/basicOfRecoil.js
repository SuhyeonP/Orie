    ...
    return (
        <>
            <div className="history-of-recoil">
                ...
                <p>
                    Redux, Mobx 는 React에서 사용하기 위해 나온것이 아니다.(react-redux , mobx-react와 같이 react 전용 wrapper라이브러리가 잇긴함) \n
                    그렇다고 React만으로 해결하려고 하니 그것도 쉬운일이 아니였다.\n
                    그래서 Recoil 개발자들은 API와 동작방식을 React 스럽게(Reactish) 가져가며 현상을 해결하기 위해 Recoil을 제작햇다고 한다.
                </p>
            </div>
            <div className="main-explain">
                <p><span>Recoil</span>은 Atom으로부터 시작해서 Selector를 거쳐 React컴포넌트까지 전달되는 하나의 Data-Flow Graph를 만들게 한다.\n
